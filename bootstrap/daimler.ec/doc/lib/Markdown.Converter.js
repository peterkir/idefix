...
/**
 * Loads the given markdownURL and appends it to the given DOM element (or directly to body, if not specified).
 */
function load(markdownURL, domElementSelector) {

  domElementSelector = domElementSelector || "body";

  var el = $(domElementSelector);
  ...
  $.ajax({
            ...
            error: function(data){
                ...
                if (window.location.origin == "file://") {
                    reason = "You have to open the browser in app-mode to allow access to file:// protocol.";
                } else {
                    reason = "File not found.";
                }
                
                var html = "<h1>Error loading markdown file</h1><p>Can't load <code>" + markdownURL + "</code>." + reason + "</p>";
                html += "<p>Try to open <a href='" + markdownURL + "'>the markdown file directly</a>.</p>."
