...
if grep -q peterkir.github.io "$ECL_INST_INI"; then
   ...
   echo "-Doomph.setup.product.catalog.filter=com\\\\.daimler\\\\.cec\\\\.products" >> "$ECL_INST_INI_BAK"
   ...
   echo "-Doomph.redirection.idefixProductCatalog=index:/redirectable.products.setup->https://peterkir.github.io/idefix/oomph/cec/productsCatalog.setup" >> "$ECL_INST_INI_BAK"
   echo "-Doomph.redirection.idefixProjectCatalog=index:/redirectable.projects.setup->https://peterkir.github.io/idefix/oomph/cec/projectsCatalog.setup" >> "$ECL_INST_INI_BAK"
