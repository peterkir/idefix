...
IF "%ERRORLEVEL%"=="" (
    ...
    ECHO -Doomph.setup.product.catalog.filter=com\.daimler\.cec\.products>> %IDEFIX_INI%
    ...
    ECHO -Doomph.redirection.klibProductCatalog=index:/redirectable.products.setup-^>https://peterkir.github.io/idefix/oomph/%CUSTOMER%/productsCatalog.setup >> %IDEFIX_INI%
    ECHO -Doomph.redirection.klibProjectCatalog=index:/redirectable.projects.setup-^>https://peterkir.github.io/idefix/oomph/%CUSTOMER%/projectsCatalog.setup >> %IDEFIX_INI%
)
