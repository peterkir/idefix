...
ECHO -Doomph.setup.product.filter=(idefix\.cec)                >> %IDEFIX_INI%
ECHO -Doomph.setup.product.version.filter=(162\.0\.0)          >> %IDEFIX_INI%
...
ECHO -Doomph.setup.installer.mode=simple                            >> %IDEFIX_INI%
ECHO -Doomph.redirection.klibProductCatalog=index:/redirectable.products.setup-^>http://peterkir.github.io/idefix/oomph/daimler/productsCatalog.setup >> %IDEFIX_INI%
ECHO -Doomph.redirection.klibProjectCatalog=index:/redirectable.projects.setup-^>http://peterkir.github.io/idefix/oomph/daimler/projectsCatalog.setup >> %IDEFIX_INI%
